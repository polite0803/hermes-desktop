export default {
  ...
  sshConnectionHint:
    "Make sure you can run <code>ssh {user}@{host}</code> without a password prompt. The first connection trusts the host key and stores it in <code>~/.ssh/known_hosts</code>; SSH will fail closed if that key changes later.",
  hostRequired: "Host and username are required",
  sshTunnelConnected: "SSH tunnel connected!",
  sshConnectionFailed: "Could not connect via SSH",
