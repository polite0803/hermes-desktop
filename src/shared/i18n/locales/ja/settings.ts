export default {
  ...
  community: "コミュニティ",
  communityDesc:
    "質問の投稿、問題報告、他のHermesユーザーとのチャットのためにTelegramグループに参加しましょう。",
  joinTelegram: "Telegramコミュニティに参加",
  theme: {
    label: "テーマ",
    system: "システム",
    light: "ライト",
  ...
  testingSSH: "SSHテスト中…",
  testSSHConnection: "SSH接続テスト",
  sshHost: "SSHホスト",
  sshPort: "SSHポート",
  username: "ユーザー名",
  privateKeyPath: "秘密鍵のパス",
  privateKeyPathOptional: "(オプション、デフォルト ~/.ssh/id_rsa)",
  remoteHermesPort: "リモートHermesポート",
  remoteHermesPortDefault: "(デフォルト 8642)",
  sshConnectionHint:
    "<code>ssh {user}@{host}</code>をパスワードなしで実行できることを確認してください。最初の接続でホストキーを信頼し、<code>~/.ssh/known_hosts</code>に保存します。そのキーが後から変更された場合、SSHは失敗します。",
  hostRequired: "ホストとユーザー名は必須です",
  sshTunnelConnected: "SSHトンネルに接続しました！",
  sshConnectionFailed: "SSHで接続できませんでした",
  enterURL: "URLを入力してください",
  connectionSuccess: "正常に接続しました！",
  ...
  migrationComplete: "移行が正常に完了しました！",
