export default {
  ...
  commands: {
    ...
    fast: "Activar/desactivar procesamiento prioritario (menor latencia)",
    compress: "Comprimir la conversación con un tema de enfoque opcional",
    usage: "Mostrar uso de tokens, coste y límites de tasa",
    debug: "Mostrar diagnósticos e información de depuración",
    goal: "Fijar el agente en un objetivo persistente entre turnos (bucle Ralph)",
    steer: "Redirigir el agente en ejecución sin interrumpirlo",
    queue: "Encolar un seguimiento para ejecutar después del turno actual",
    ...
    reloadSkills: "Recargar el directorio de habilidades sin reiniciar",
    kanban: "Listar o gestionar tareas kanban",
    curator: "Mostrar estado del curator (habilidades por uso)",
