export default {
  ...
  backupCreated: "Copia de seguridad creada: {{path}}",
  ...
  testingSSH: "Probando SSH…",
  testSSHConnection: "Probar conexión SSH",
  sshHost: "Host SSH",
  sshPort: "Puerto SSH",
  username: "Usuario",
  privateKeyPath: "Ruta de clave privada",
  privateKeyPathOptional: "(opcional, predeterminado ~/.ssh/id_rsa)",
  remoteHermesPort: "Puerto remoto de Hermes",
  remoteHermesPortDefault: "(predeterminado 8642)",
  sshConnectionHint:
    "Asegúrate de poder ejecutar <code>ssh {user}@{host}</code> sin solicitud de contraseña. La primera conexión confía en la clave del host y la almacena en <code>~/.ssh/known_hosts</code>; SSH fallará si esa clave cambia posteriormente.",
  hostRequired: "El host y el usuario son obligatorios",
  sshTunnelConnected: "¡Túnel SSH conectado!",
  sshConnectionFailed: "No se pudo conectar mediante SSH",
  enterURL: "Por favor, introduce una URL",
  connectionSuccess: "¡Conectado correctamente!",
  connectionFailed: "No se pudo alcanzar el servidor",
  save: "Guardar",
  ...
  sandboxBackendHint: "Elige dónde se ejecutan los comandos de terminal.",
  sandboxLocal: "Local",
