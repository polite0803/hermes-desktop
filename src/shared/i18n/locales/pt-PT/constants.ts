export default {
  ...
  localTag: "",
  customOpenAICompatibleName: "OpenAI Compatível / Local",
  xaiOAuth: "xAI Grok (OAuth)",
  qwenOAuth: "Qwen (OAuth)",
  geminiCliOAuth: "Gemini CLI (OAuth)",
  minimaxOAuth: "MiniMax (OAuth)",
