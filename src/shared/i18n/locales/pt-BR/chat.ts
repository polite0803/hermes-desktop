export default {
  ...
  clearChatConfirm: "Limpar esta conversa? Esta ação não pode ser desfeita.",
  ...
  commands: {
    ...
    fast: "Ativar/desativar processamento prioritário (menor latência)",
    ...
    goal: "Fixar o agente em um objetivo persistente entre turnos (loop Ralph)",
    steer: "Redirecionar o agente em execução sem interrompê-lo",
    queue: "Enfileirar um acompanhamento para executar após o turno atual",
    update: "Atualizar o Hermes para a versão mais recente",
    ...
    reloadSkills: "Recarregar o diretório de habilidades sem reiniciar",
    kanban: "Listar ou gerenciar tarefas kanban",
    curator: "Mostrar status do curator (habilidades por uso)",
