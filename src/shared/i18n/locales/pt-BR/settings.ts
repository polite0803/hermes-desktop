export default {
  ...
  communityDesc:
    "Junte-se ao nosso grupo do Telegram para fazer perguntas, relatar problemas e conversar com outros usuários do Hermes.",
  joinTelegram: "Entrar na Comunidade do Telegram",
  theme: {
    label: "Tema",
    system: "Sistema",
    light: "Claro",
  ...
  modeSSHTunnelHint:
    "Conecte-se a um Hermes remoto via SSH — sem portas expostas ou chaves API necessárias.",
  ...
  testSSHConnection: "Testar Conexão SSH",
  sshHost: "Host SSH",
  sshPort: "Porta SSH",
  username: "Usuário",
  ...
  sshConnectionHint:
    "Certifique-se de poder executar <code>ssh {user}@{host}</code> sem prompt de senha. A primeira conexão confia na chave do host e a armazena em <code>~/.ssh/known_hosts</code>; o SSH falhará se essa chave mudar depois.",
  hostRequired: "Host e usuário são obrigatórios",
  sshTunnelConnected: "Túnel SSH conectado!",
  sshConnectionFailed: "Não foi possível conectar via SSH",
  enterURL: "Por favor, insira uma URL",
  connectionSuccess: "Conectado com sucesso!",
  connectionFailed: "Não foi possível acessar o servidor",
  save: "Salvar",
  ...
  autoDetected: "detectado automaticamente da URL base",
