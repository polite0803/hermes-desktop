...
export const PROVIDERS = {
  ...
  options: [
    ...
    { value: "mistral", label: "constants.mistralName" },
    { value: "deepseek", label: "constants.deepseekName" },
    { value: "groq", label: "constants.groqName" },
    { value: "together", label: "constants.togetherName" },
    { value: "fireworks", label: "constants.fireworksName" },
    { value: "cerebras", label: "constants.cerebrasName" },
    { value: "perplexity", label: "constants.perplexityName" },
    { value: "huggingface", label: "constants.huggingfaceName" },
    { value: "nvidia", label: "constants.nvidiaName" },
    ...
    { value: "xai-oauth", label: "constants.xaiOAuth" },
    { value: "qwen-oauth", label: "constants.qwenOAuth" },
    { value: "google-gemini-cli", label: "constants.geminiCliOAuth" },
    { value: "minimax-oauth", label: "constants.minimaxOAuth" },
    { value: "kimi-coding", label: "constants.kimiCoding" },
  ...
  labels: {
    ...
    mistral: "constants.mistralName",
    deepseek: "constants.deepseekName",
    groq: "constants.groqName",
    together: "constants.togetherName",
    fireworks: "constants.fireworksName",
    cerebras: "constants.cerebrasName",
    perplexity: "constants.perplexityName",
    huggingface: "constants.huggingfaceName",
    nvidia: "constants.nvidiaName",
    zai: "constants.zaiName",
    qwen: "constants.qwenName",
    minimax: "constants.minimaxName",
    nous: "constants.nousName",
    "xai-oauth": "constants.xaiOAuth",
    "qwen-oauth": "constants.qwenOAuth",
    "google-gemini-cli": "constants.geminiCliOAuth",
    "minimax-oauth": "constants.minimaxOAuth",
    "kimi-coding": "constants.kimiCoding",
...
export const INSTALL_CMD = isWindowsPlatform()
  ? WINDOWS_INSTALL_CMD
  : UNIX_INSTALL_CMD;
...
export function getInstallCmd(): string {
  return isWindowsPlatform() ? WINDOWS_INSTALL_CMD : UNIX_INSTALL_CMD;
}
