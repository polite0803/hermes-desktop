  ...
  if (loading)
    return (
      <div className="settings-container">
        <h1 className="settings-header">{t("curator.title")}</h1>
      ...
      <div className="models-header">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <button className="btn btn-sm" onClick={load}>
            <RefreshCw size={14} /> {t("curator.refresh")}
          </button>
          <button className="btn btn-primary btn-sm" onClick={trigger}>
            <Play size={14} /> {t("curator.runCurator")}
          </button>
        </div>
      </div>
